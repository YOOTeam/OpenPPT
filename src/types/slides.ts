 ...
 * 颜色通用
 *
 * type: 类型：themeColor、rgb
 *
 * value: 颜色值，如果是themeColor，则为id；否则为十六进制色值
 *
 * transparent: 不透明度0~1
 */
...
interface TextProperty {
  ...
  fontSzie?: string
  fontName?: string
  fontColor?: ColorStyle // 颜色
  fontBackColor?: ColorStyle
  bold?: boolean
  italic?: boolean
  underline?: boolean
  delline?: boolean
 ...
 * src: 图片地址
 *
 * style: 外框样式 none pc mobile browser
 *
 * flipH?: 水平翻转
 *
 * flipV?: 垂直翻转
...
export interface PPTShapeElement extends PPTBaseElement {
  ...
  softEdge?: any // 是否开启软边
  attrArry?: any[] // 形状属性数组
  imgFillType?: any // 形状属性
  isPlaceHolder?: boolean // 是否为占位符
  multiColor?: boolean // 是否是多色
}
 ...
 * animations?: 元素动画集合
 *
 * actionList?:交互元素{elInteractionType:'default',elements:[] }
 *
 * turningMode?: 翻页方式
 */
 ...
 * backgroundColorLight: 页面背景颜色浅色
 * themeColor: 主题色，用于默认创建的形状颜色等
 * fontColor: 字体颜色
 * fontColorLight: 字体颜色浅色
 *
 * fontName: 字体
 */
